...
@Component({
    ...
    styles: [`
        ...
        .app-dark .pg-toggle__save { border-color: rgba(var(--hos-accent-rgb),.35); }
        .pg-toggle__hint {
        ...
        .app-dark .gos-plan__price--custom { border-color: rgba(var(--hos-accent-rgb),.3); }
        ...
        .app-dark .gos-plan--enterprise {
            background: linear-gradient(160deg, var(--hos-surface) 60%, rgba(var(--hos-accent-rgb),.05));
        }
